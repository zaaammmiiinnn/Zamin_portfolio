...
const projects = [
    {
        ...
        description: "A full-frontend portfolio website with an analytics dashboard.",
        tags: ["HTML5", "CSS3", "JavaScript"],
        github: "https://github.com/zaaammmiiinnn/portfolio1",
        demo: "https://portfolio1-chi-sooty.vercel.app/index.html",
        featured: true,
    },
    {
        title: "Netflix Clone",
        description: "My first project, fully made with HTML and CSS with no Javascript",
        tags: ["HTML5", "CSS3"],
        github: "https://github.com/zaaammmiiinnn/Netflix_clone",
